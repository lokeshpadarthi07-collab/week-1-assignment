...
export function BlogPage({ showToast }) {
  ...
  useEffect(() => {
    fetch(`${baseApiUrl}/api/posts`)
      ...
      .catch((err) => {
        console.warn('Backend API connection offline, running in local fallback mode:', err);
      });
  }, [baseApiUrl]);
  ...
  const handleLikePost = (id) => {
    ...
    fetch(`${baseApiUrl}/api/posts/${id}/like`, {
      method: 'POST',
  ...
  const handleAddComment = (e) => {
    ...
    fetch(`${baseApiUrl}/api/posts/${activePost.id}/comments`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  return (
    <div className="blog-page">
      <div className="container">
        ...
        <div className="categories-filter-bar glass-card">
          <div className="category-pills">
            ...
            >
              Saved ({bookmarkedPosts.size})
            </button>
          </div>

          <Button variant="primary" icon={PlusCircle} size="sm" onClick={() => setIsCreateModalOpen(true)}>
            Write Post
          </Button>
        </div>
            ...
            <div className="featured-card glass-card">
              ...
              <div className="featured-content-col">
                ...
                <div className="featured-actions">
                  <Button variant="primary" size="lg" onClick={() => setActivePost(featuredPost)}>
                    Read Featured Story
                  </Button>
                  <Button
        ...
        <div className="controls-bar">
          <div className="results-info">
            ...
            <span className="results-count">Showing {filteredPosts.length} posts</span>
          </div>
        ...
        {filteredPosts.length > 0 ? (
          ...
          <div className="empty-state glass-card">
            ...
            <p>Try searching for another keyword or resetting category filters.</p>
              ...
              <div className="comments-section">
                ...
                <div className="comments-list">
                  {(commentsMap[activePost.id] || []).length > 0 ? (
                    ...
                    <p className="no-comments">No comments yet. Be the first to start discussion!</p>
                  )}
                </div>
        ...
        <div className="modal-backdrop" onClick={() => setIsCreateModalOpen(false)}>
          <div className="modal-content glass-card form-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <Form
              ...
              description="Share your tech insights with the community."
